...
const val DAILY_TASKS_RECEIVER_PENDING_INTENT_REQ = NOTIFICATION_TASK_REQ + 1

const val REMINDER_TIME_ADDITION = 10    // 10m
const val DOUBLE_BACK_INTERVAL = 2000L  // 2s